...
struct ConnectedCall {
    ...
    local_video: mpsc::Sender<freecord_media::VideoFrame>,
}
...
impl Shell {
    ...
    fn render_profile_setup(&mut self, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        div()
            ...
            .gap_4()
            .w(px(320.))
            .child(div().text_size(px(19.)).font_weight(FontWeight::BOLD).child("freecord"))
            .child(
                div()
                    .flex()
                    .flex_col()
...
fn main() {
    freecord_media::init().expect("failed to initialize GStreamer");
        ...
        let window = cx
            .open_window(
                WindowOptions {
                    ...
                    titlebar: Some(TitlebarOptions { title: Some("freecord".into()), ..Default::default() }),
